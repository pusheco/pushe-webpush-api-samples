...
namespace csharp
{
    class Program
    {
        ...
        public static StringContent getNotificationData()
        {
            ...
            data.Add("title", "This is a filtered push");
            data.Add("content", "Only users with specified device_id(s) will see this notification.");
            ...
            request_data.Add("filters", filters);
